import { fixJsonEscaping, extractMcpCliJson, checkAndFixMcpCliJson } from './dist/pre-tool-use/json-auto-escape.js';
...
// Test 3: Full mcp-cli command with valid JSON
...
console.log('Test 3 - mcp-cli command check (valid JSON):');
