...
export {
  ensureGoodVibesDirsCompat as ensureGoodVibesDirs,
  loadActiveAgentsCompat as loadActiveAgents,
  saveActiveAgentsCompat as saveActiveAgents,
  registerActiveAgentCompat as registerActiveAgent,
  popActiveAgentCompat as popActiveAgent,
  cleanupStaleAgentsCompat as cleanupStaleAgents,
