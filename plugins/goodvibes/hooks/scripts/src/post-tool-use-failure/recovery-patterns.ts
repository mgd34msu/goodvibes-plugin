...
export const RECOVERY_PATTERNS: RecoveryPattern[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Run `npx tsc --noEmit` to identify all type errors. Check that types are correctly imported and match expected signatures.',
    severity: 'high',
  },
  {
    ...
    suggestedFix:
      'Check tsconfig.json configuration. Ensure module resolution settings match your import style. You may need to install @types/* packages.',
    severity: 'medium',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Run `npm install` to ensure all dependencies are installed. Check that the import path is correct and the package exists in package.json.',
    severity: 'high',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Check function signatures and ensure arguments match. Review type definitions and update interface if needed.',
    severity: 'medium',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Add null checks or optional chaining (?.). Ensure variables are properly initialized before use.',
    severity: 'high',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Run `npx eslint . --fix` to auto-fix linting issues. For Prettier errors, run `npx prettier --write .`.',
    severity: 'low',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Review the test output to understand the assertion failure. Check if the implementation matches the expected behavior or if the test needs updating.',
    severity: 'high',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Check the build output for specific errors. Common issues include missing dependencies, invalid imports, or configuration errors.',
    severity: 'critical',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Try `npm install --legacy-peer-deps` for peer dependency conflicts. Check package.json for missing or malformed entries.',
    severity: 'medium',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Verify the file path exists. Check for typos in the path and ensure the file has been created.',
    severity: 'medium',
  },
  {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Resolve any merge conflicts manually. Pull latest changes with `git pull` before pushing.',
    severity: 'medium',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Ensure the database server is running. Check connection string in environment variables. Run pending migrations.',
    severity: 'high',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Check API endpoint URL and network connectivity. Verify authentication tokens are valid and not expired.',
    severity: 'medium',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Increase Node.js memory limit with `NODE_OPTIONS=--max-old-space-size=4096`. Check for memory leaks or infinite recursion.',
    severity: 'critical',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    suggestedFix:
      'Check for typos, missing brackets, or incorrect syntax. Use an editor with syntax highlighting to identify issues.',
        severity: 'high',
  },

  // Shell Escaping Errors (MCP precision tools via bash)
  {
    category: 'shell_escaping_error',
    description: 'Shell escaping error in mcp-cli precision tool call',
    patterns: [
      ...
      /syntax error near unexpected token/,
        ...
        suggestedFix:
      'SHELL ESCAPING ERROR: Content contains characters breaking shell parsing.
