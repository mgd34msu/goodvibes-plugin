 ...
 * }
 */
function isValidPhase(phase: number): phase is 1 | 2 | 3 {
 ...
 */
export function getRetryLimit(category: ErrorCategory): number {
 ...
 */
export function getRemainingAttemptsInPhase(state: ErrorState): number {
