...
describe('stop hook', () => {
  ...
  beforeEach(() => {
    ...
    // Default mock for respond - just records the call (don't throw to avoid unhandled rejections)
  ...
  describe('successful session end with analytics', () => {
    it('should finalize analytics and save session summary', async () => {
      ...
      // Verify session summary file was written (path separator varies by OS)
  ...
  describe('temp file cleanup', () => {
    it('should delete temp files that exist', async () => {
      ...
      // Verify temp file was deleted (path separator varies by OS)
