...
import { parseTimeFilter, getProjectDirectories, extractMcpTool } from './parser.js';
...
export function findSubagentFiles(timeFilter) {
...
export function parseSubagentSession(filePath, timeFilter) {
    const filter = timeFilter || parseTimeFilter();
    try {
...
export async function analyzeSubagents(timeFilter) {
    const filter = timeFilter || parseTimeFilter();
