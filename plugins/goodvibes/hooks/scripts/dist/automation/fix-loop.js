 ...
 */
export function generateErrorSignature(toolName, errorMessage) {
 ...
 */
export function categorizeError(_toolName, errorMessage) {
 ...
 */
export function createErrorState(signature, category) {
    return {
        signature,
        category,
        phase: 1,
 ...
 */
export function buildFixContext(state, error) {
    const parts = [];
