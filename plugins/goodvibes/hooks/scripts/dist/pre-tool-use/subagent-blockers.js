 ...
 */
export function formatBlockMessage(toolName, replacement) {
...
*/
export function isBlockedNativeTool(toolName) {
 ...
 */
export function handleNativeToolBlocking(input) {
 ...
 */
export function getBatchProcessingReminder() {
    return ('REMINDER: For efficiency, prefer precision tools and batch operations:\n' +
