 ...
 */
import { respond, readHookInput, loadAnalytics, saveAnalytics, debug, logError, isTestEnvironment, buildGvDirectiveTag, } from '../shared/index.js';
 ...
 * @param options.additionalContext - Additional context to inject (e.g. directives)
...
async function runSubagentStopHook() {
    try {
        ...
        // After sending the event, queries for directives and injects them via additionalContext.
        ...
        try {
            ...
            if (runtimeClient.isAvailable()) {
                ...
                // Query for directives generated by the event we just sent
