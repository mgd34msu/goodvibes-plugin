 ...
 */
export function ensureGoodVibesDirs() {
 ...
 */
export function loadActiveAgents() {
    ensureGoodVibesDirs();
 ...
 */
export function registerActiveAgent(entry) {
 ...
 */
export function popActiveAgent(agentId) {
    const state = loadActiveAgents();
 ...
 */
export function writeTelemetryRecord(record) {
    ensureGoodVibesDirs();
