/**
 * Utility functions for project-engine v2.0.0
 */
 ...
 *
 * @deprecated Use createSuccessResponse from shared/response.ts instead.
 * Kept for backwards compatibility with handlers that import from utils.
 */
 ...
 *
 * @deprecated Use createErrorResponse from shared/response.ts instead.
 * Kept for backwards compatibility with handlers that import from utils.
 */
