 ...
 *
 * Aggregates all 26 MCP tool schemas from the 8 domain schema modules
 * into a single TOOL_SCHEMAS export for use by the MCP dispatch layer.
 *
 * This is a pure re-export/aggregation layer with no business logic.
 *
...
const CODE_INTEL_SCHEMAS: readonly Tool[] = [
  {
...
const API_SCHEMAS: readonly Tool[] = [
  {
...
const SECURITY_SCHEMAS: readonly Tool[] = [
  {
...
const DATABASE_SCHEMAS: readonly Tool[] = [
  {
...
const DEPS_SCHEMAS: readonly Tool[] = [
  {
...
const TESTING_SCHEMAS: readonly Tool[] = [
  {
...
const RUNTIME_SCHEMAS: readonly Tool[] = [
  {
...
const STANDALONE_SCHEMAS: readonly Tool[] = [
  {
    name: 'scaffold',
 ...
 */
export const TOOL_SCHEMAS: readonly Tool[] = [
  ...CODE_INTEL_SCHEMAS,
  ...API_SCHEMAS,
  ...SECURITY_SCHEMAS,
  ...DATABASE_SCHEMAS,
