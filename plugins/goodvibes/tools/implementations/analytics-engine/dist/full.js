...
function MetricBox({ title, width = 40, rows }) {
  ...
  return /* @__PURE__ */ jsxs(
    Box,
    {
      ...
      borderColor: "cyan",
      children: [
        /* @__PURE__ */ jsx(Box, { width: innerWidth, justifyContent: "center", children: /* @__PURE__ */ jsx(Text, { bold: true, color: "cyan", children: title }) }),
        /* @__PURE__ */ jsx(Box, { width: innerWidth, children: /* @__PURE__ */ jsx(Text, { color: "gray", children: "\u2500".repeat(innerWidth) }) }),
        rows.length === 0 ? /* @__PURE__ */ jsx(Box, { width: innerWidth, justifyContent: "center", children: /* @__PURE__ */ jsx(Text, { color: "gray", dimColor: true, children: "No data" }) }) : rows.map((row, idx) => /* @__PURE__ */ jsxs(Box, { width: innerWidth, justifyContent: "space-between", children: [
          /* @__PURE__ */ jsx(Text, { color: "white", children: row.label }),
          /* @__PURE__ */ jsx(Text, { color: "yellow", bold: true, children: row.value })
        ] }, idx))
      ]
    }
  );
}
__name(MetricBox, "MetricBox");

// src/tui/full/components/bar-chart.tsx
import { Box as Box2, Text as Text2 } from "ink";

// src/tui/full/components/text-utils.ts
function fixedWidth(str, width) {
  if (str.length > width) return str.slice(0, width - 1) + "\u2026";
  return str.padEnd(width);
}
__name(fixedWidth, "fixedWidth");
...
function BarChart({
  ...
  if (items.length === 0) {
    return /* @__PURE__ */ jsx2(Box2, { width, children: /* @__PURE__ */ jsx2(Text2, { color: "gray", dimColor: true, children: "No data" }) });
  }
  ...
  return /* @__PURE__ */ jsx2(Box2, { flexDirection: "column", width, children: items.map((item, idx) => {
    ...
    return /* @__PURE__ */ jsxs2(Box2, { flexDirection: "row", width, children: [
      /* @__PURE__ */ jsx2(Text2, { color: "white", children: fixedWidth(item.label, labelColWidth) }),
      /* @__PURE__ */ jsx2(Text2, { children: "  " }),
      /* @__PURE__ */ jsx2(Text2, { color: "green", children: barChar.repeat(filled) }),
      /* @__PURE__ */ jsx2(Text2, { color: "gray", dimColor: true, children: emptyChar.repeat(empty) }),
      /* @__PURE__ */ jsx2(Text2, { children: "  " }),
      /* @__PURE__ */ jsx2(Text2, { color: "yellow", bold: true, children: valueStr.padStart(valueColWidth) })
    ] }, idx);
  }) });
}
__name(BarChart, "BarChart");

// src/tui/full/components/table.tsx
import React from "react";
import { Box as Box3, Text as Text3 } from "ink";
import { jsx as jsx3, jsxs as jsxs3 } from "react/jsx-runtime";
function borderLine(widths, left, middle, right, fill) {
...
function Table({ headers, rows, columnWidths }) {
  if (headers.length === 0) {
    return /* @__PURE__ */ jsx3(Box3, { children: /* @__PURE__ */ jsx3(Text3, { color: "gray", dimColor: true, children: "No data" }) });
  }
  ...
  function dataRow(cells, isHeader = false) {
    return /* @__PURE__ */ jsxs3(Box3, { flexDirection: "row", children: [
      ...
      widths.map((w, ci) => /* @__PURE__ */ jsxs3(React.Fragment, { children: [
        /* @__PURE__ */ jsx3(
          Text3,
          {
            bold: isHeader,
            color: isHeader ? "cyan" : "white",
            children: ` ${fixedWidth(cells[ci] ?? "", w)} `
          }
        ),
        /* @__PURE__ */ jsx3(Text3, { color: "gray", children: "\u2502" })
      ] }, ci))
  ...
  return /* @__PURE__ */ jsxs3(Box3, { flexDirection: "column", children: [
    /* @__PURE__ */ jsx3(Text3, { color: "gray", children: topBorder }),
    dataRow(headers, true),
    /* @__PURE__ */ jsx3(Text3, { color: "gray", children: midBorder }),
    rows.length === 0 ? /* @__PURE__ */ jsxs3(Box3, { children: [
      /* @__PURE__ */ jsx3(Text3, { color: "gray", children: "\u2502" }),
      /* @__PURE__ */ jsx3(Text3, { color: "gray", dimColor: true, children: ` ${"No data".padEnd(totalInnerWidth)} ` }),
      /* @__PURE__ */ jsx3(Text3, { color: "gray", children: "\u2502" })
    ] }) : rows.map((row, idx) => /* @__PURE__ */ jsxs3(React.Fragment, { children: [
      dataRow(row),
      idx < rows.length - 1 && /* @__PURE__ */ jsx3(Text3, { color: "gray", children: midBorder })
    ] }, idx)),
    /* @__PURE__ */ jsx3(Text3, { color: "gray", children: btmBorder })
  ] });
}
__name(Table, "Table");

// src/tui/full/components/timeline-feed.tsx
...
function TimelineFeed({
  ...
  if (visible.length === 0) {
    return /* @__PURE__ */ jsx4(Box4, { children: /* @__PURE__ */ jsx4(Text4, { color: "gray", dimColor: true, children: "No recent activity" }) });
  }
  return /* @__PURE__ */ jsx4(Box4, { flexDirection: "column", children: visible.map((event, idx) => {
    ...
    return /* @__PURE__ */ jsxs4(Box4, { flexDirection: "row", children: [
      /* @__PURE__ */ jsx4(Text4, { color: "gray", children: formatTime(event.timestamp) }),
      /* @__PURE__ */ jsx4(Text4, { children: "  " }),
      /* @__PURE__ */ jsx4(Text4, { children: icon }),
      /* @__PURE__ */ jsx4(Text4, { children: " " }),
      /* @__PURE__ */ jsx4(Text4, { color, bold: true, children: typeLabel }),
      /* @__PURE__ */ jsx4(Text4, { children: "  " }),
      /* @__PURE__ */ jsx4(Text4, { color: "white", children: event.description })
    ] }, idx);
  }) });
}
__name(TimelineFeed, "TimelineFeed");

// src/tui/full/components/heatmap.tsx
...
function shortPath(fullPath, maxLen = 28) {
...
function Heatmap({
  ...
  if (files.length === 0) {
    return /* @__PURE__ */ jsx5(Box5, { width, children: /* @__PURE__ */ jsx5(Text5, { color: "gray", dimColor: true, children: "No file activity" }) });
  }
  const sorted = [...files].sort((a, b) => b.reads + b.writes - (a.reads + a.writes)).slice(0, maxItems);
  const maxAccess = Math.max(...sorted.map((f) => f.reads + f.writes), 1);
  const countColWidth = 12;
  const nameColWidth = Math.max(width - BAR_COLS - countColWidth - 4, 10);
  return /* @__PURE__ */ jsx5(Box5, { flexDirection: "column", width, children: sorted.map((file, idx) => {
    ...
    return /* @__PURE__ */ jsxs5(Box5, { flexDirection: "row", width, children: [
      /* @__PURE__ */ jsx5(Text5, { color: "white", children: name.padEnd(nameColWidth, " ") }),
      /* @__PURE__ */ jsx5(Text5, { children: "  " }),
      /* @__PURE__ */ jsx5(Text5, { color, children: HEAT_CHAR.repeat(filled) }),
      /* @__PURE__ */ jsx5(Text5, { color: "gray", dimColor: true, children: HEAT_EMPTY.repeat(empty) }),
      /* @__PURE__ */ jsx5(Text5, { children: "  " }),
      /* @__PURE__ */ jsx5(Text5, { color: "yellow", children: countStr.padEnd(countColWidth) })
    ] }, idx);
  }) });
}
__name(Heatmap, "Heatmap");

// src/tui/full/components/trend-line.tsx
...
function TrendLine({
  ...
  return /* @__PURE__ */ jsxs6(Box6, { flexDirection: "row", width, children: [
    ...
    /* @__PURE__ */ jsx6(Text6, { color: "green", children: FILL_CHAR.repeat(filled) }),
    /* @__PURE__ */ jsx6(Text6, { color: "gray", dimColor: true, children: EMPTY_CHAR.repeat(empty) }),
    /* @__PURE__ */ jsx6(Text6, { children: "  " }),
    /* @__PURE__ */ jsx6(Text6, { color: "yellow", bold: true, children: valueStr }),
    /* @__PURE__ */ jsx6(Text6, { color: "gray", children: " \u2502" }),
    /* @__PURE__ */ jsx6(Text6, { color, bold: true, children: trendStr })
  ] });
}
__name(TrendLine, "TrendLine");
...
__name(formatDelta, "formatDelta");
...
var SessionOverview = /* @__PURE__ */ __name(({ state, globalDb }) => {
  ...
  const toolItems = Object.entries(tools_breakdown).map(([name, tb]) => ({
  ...
  return /* @__PURE__ */ jsxs7(Box7, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1, children: [
    /* @__PURE__ */ jsxs7(Box7, { gap: 3, children: [
      /* @__PURE__ */ jsx7(Text7, { bold: true, color: "cyan", children: "SESSION OVERVIEW" }),
      /* @__PURE__ */ jsxs7(Text7, { dimColor: true, children: [
        "ID: ",
        truncate(session_id, 24)
      ] }),
      /* @__PURE__ */ jsxs7(Text7, { dimColor: true, children: [
        "Started: ",
        formatTime2(started_at)
      ] }),
      /* @__PURE__ */ jsxs7(Text7, { dimColor: true, children: [
        "Up: ",
    ...
    tags.length > 0 && /* @__PURE__ */ jsxs7(Box7, { gap: 1, children: [
      /* @__PURE__ */ jsx7(Text7, { dimColor: true, children: "Tags:" }),
      tags.map((tag) => /* @__PURE__ */ jsxs7(Text7, { color: "cyan", children: [
        "[",
        tag,
        "]"
      ] }, tag))
    ] }),
    /* @__PURE__ */ jsxs7(Box7, { gap: 1, flexWrap: "wrap", children: [
      /* @__PURE__ */ jsx7(
        MetricBox,
        {
    ...
    toolItems.length > 0 && /* @__PURE__ */ jsxs7(Box7, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx7(Text7, { bold: true, color: "yellow", children: "TOOLS BREAKDOWN" }),
      /* @__PURE__ */ jsx7(
        BarChart,
        {
...
// src/tui/full/pages/activity-hotspots.tsx
import { Box as Box8, Text as Text8 } from "ink";
import { jsx as jsx8, jsxs as jsxs8 } from "react/jsx-runtime";
var severityIcon = /* @__PURE__ */ __name((severity) => severity === "alert" ? "!!" : "! ", "severityIcon");
var severityColor = /* @__PURE__ */ __name((severity) => severity === "alert" ? "red" : "yellow", "severityColor");
var ActivityHotspots = /* @__PURE__ */ __name(({ state }) => {
  const { recent_activity, file_hotspots, agent_profiles, anomalies } = state;
  const agentItems = [...agent_profiles].sort((a, b) => b.tokens_in + b.tokens_out - (a.tokens_in + a.tokens_out)).slice(0, 10).map((ap) => ({
  ...
  return /* @__PURE__ */ jsxs8(Box8, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1, children: [
    /* @__PURE__ */ jsx8(Text8, { bold: true, color: "cyan", children: "ACTIVITY & HOTSPOTS" }),
    /* @__PURE__ */ jsxs8(Box8, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx8(Text8, { bold: true, color: "yellow", children: "RECENT ACTIVITY" }),
      /* @__PURE__ */ jsx8(TimelineFeed, { events: recent_activity, maxItems: 12 })
    ] }),
    /* @__PURE__ */ jsxs8(Box8, { gap: 2, flexWrap: "wrap", children: [
      /* @__PURE__ */ jsxs8(Box8, { flexDirection: "column", gap: 0, flexGrow: 1, minWidth: 30, children: [
        /* @__PURE__ */ jsx8(Text8, { bold: true, color: "yellow", children: "FILE HOTSPOTS" }),
        /* @__PURE__ */ jsx8(Heatmap, { files: file_hotspots, maxItems: 8 })
      ] }),
      agentItems.length > 0 && /* @__PURE__ */ jsxs8(Box8, { flexDirection: "column", gap: 0, flexGrow: 1, minWidth: 30, children: [
        /* @__PURE__ */ jsx8(Text8, { bold: true, color: "yellow", children: "AGENT BREAKDOWN" }),
        /* @__PURE__ */ jsx8(
          BarChart,
          {
    ...
    anomalies.length > 0 && /* @__PURE__ */ jsxs8(Box8, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx8(Text8, { bold: true, color: "yellow", children: "ANOMALIES & RECOMMENDATIONS" }),
      anomalies.slice(0, 6).map((anomaly) => /* @__PURE__ */ jsxs8(Box8, { gap: 1, children: [
        /* @__PURE__ */ jsx8(Text8, { color: severityColor(anomaly.severity), children: severityIcon(anomaly.severity) }),
        /* @__PURE__ */ jsxs8(
          Text8,
          {
        ...
        /* @__PURE__ */ jsx8(Text8, { children: truncate(anomaly.message, 80) })
      ] }, anomaly.id))
    ] }),
    agent_profiles.length > 0 && /* @__PURE__ */ jsx8(Box8, { gap: 3, children: /* @__PURE__ */ jsxs8(Text8, { dimColor: true, children: [
      "Agents: ",
      formatNumber(agent_profiles.length),
      " total  |",
      " ",
      formatNumber(agent_profiles.filter((a) => a.status === "active").length),
      " active  | avg success: ",
      formatPercent(
...
// src/tui/full/pages/historical.tsx
...
function avgCost(sessions) {
  if (sessions.length === 0) return 0;
  return sessions.reduce((s, x) => s + x.total_cost_usd, 0) / sessions.length;
}
__name(avgCost, "avgCost");
function avgTokens(sessions) {
  if (sessions.length === 0) return 0;
...
function avgInputTokens(sessions) {
  if (sessions.length === 0) return 0;
  return sessions.reduce((s, x) => s + x.total_input_tokens, 0) / sessions.length;
}
__name(avgInputTokens, "avgInputTokens");
function avgOutputTokens(sessions) {
  if (sessions.length === 0) return 0;
  return sessions.reduce((s, x) => s + x.total_output_tokens, 0) / sessions.length;
}
__name(avgOutputTokens, "avgOutputTokens");
function avgAgentSpawns(sessions) {
  if (sessions.length === 0) return 0;
...
var Historical = /* @__PURE__ */ __name(({ state, globalDb }) => {
  ...
  const comparisonRows = [
    [
      ...
      hasHistory && sessionAvgTokens > 0 ? formatDelta(currentTotalTokens, sessionAvgTokens) : "\u2014"
    ],
    [
      "API Input Tok",
    ...
    [
      ...
      hasHistory && sessionAvgCost > 0 ? formatDelta(cost.total, sessionAvgCost) : "\u2014"
    ],
    [
      "Cost Saved",
  ...
  const costSavedRatio = cost.total + cost.saved > 0 ? cost.saved / (cost.total + cost.saved) : 0;
  return /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1, children: [
    /* @__PURE__ */ jsx9(Text9, { bold: true, color: "cyan", children: "HISTORICAL & TRENDS" }),
    hasHistory && /* @__PURE__ */ jsxs9(Text9, { dimColor: true, children: [
      "Comparing against ",
    ...
    /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx9(Text9, { bold: true, color: "yellow", children: "CURRENT SESSION vs AVERAGES" }),
      /* @__PURE__ */ jsx9(
        Table,
        {
    ...
    /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx9(Text9, { bold: true, color: "yellow", children: "RECENT SESSIONS" }),
      sessionRows.length > 0 ? /* @__PURE__ */ jsx9(
        Table,
        {
      ...
      ) : /* @__PURE__ */ jsx9(Text9, { dimColor: true, children: "No historical sessions found in global DB. Sessions are recorded as they complete." })
    ] }),
    /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx9(Text9, { bold: true, color: "yellow", children: "PROJECT HEALTH TRENDS" }),
      /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", gap: 0, children: [
        /* @__PURE__ */ jsx9(
          TrendLine,
          {
...
// src/tui/full/pages/cross-project.tsx
import { useMemo as useMemo3 } from "react";
import { Box as Box10, Text as Text10 } from "ink";
import { jsx as jsx10, jsxs as jsxs10 } from "react/jsx-runtime";
function buildProjectSummaries(db) {
  try {
    const sessions = db.getAllSessions({ limit: 1e3 });
...
__name(shortDate2, "shortDate");
var CrossProject = /* @__PURE__ */ __name(({ state, globalDb }) => {
  ...
  const currentProjectSessions = useMemo3(() => {
    if (!globalDb || !state.session_id) return [];
    try {
      const current = globalDb.getSession(state.session_id);
      if (!current) return [];
  ...
  const avgProjectSessionCost = currentProjectSessions.length > 0 ? currentProjectSessions.reduce((s, x) => s + x.total_cost_usd, 0) / currentProjectSessions.length : 0;
  const currentCost = state.metrics.cost.total;
  const costVsAvg = avgProjectSessionCost > 0 ? currentCost / avgProjectSessionCost : 0;
  if (!globalDb) {
    return /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1, children: [
      /* @__PURE__ */ jsx10(Text10, { bold: true, color: "cyan", children: "CROSS-PROJECT ANALYTICS" }),
      /* @__PURE__ */ jsx10(Text10, { dimColor: true, children: "Global analytics database not available. Start a session with the analytics-engine daemon to begin tracking cross-project data." })
    ] });
  }
  return /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1, children: [
    /* @__PURE__ */ jsx10(Text10, { bold: true, color: "cyan", children: "CROSS-PROJECT ANALYTICS" }),
    /* @__PURE__ */ jsxs10(Box10, { gap: 1, flexWrap: "wrap", children: [
      /* @__PURE__ */ jsx10(
        MetricBox,
        {
          title: "GLOBAL TOTALS",
    ...
    spendItems.length > 0 && /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx10(Text10, { bold: true, color: "yellow", children: "SPEND BY PROJECT" }),
      /* @__PURE__ */ jsx10(BarChart, { items: spendItems })
    ] }),
    projectTableRows.length > 0 && /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx10(Text10, { bold: true, color: "yellow", children: "PROJECT BREAKDOWN" }),
      /* @__PURE__ */ jsx10(
        Table,
        {
    ...
    sessionTableRows.length > 0 && /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx10(Text10, { bold: true, color: "yellow", children: "RECENT SESSIONS" }),
      /* @__PURE__ */ jsx10(
        Table,
        {
    ...
    currentProjectSessions.length > 1 && /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", gap: 0, children: [
      /* @__PURE__ */ jsx10(Text10, { bold: true, color: "yellow", children: "CURRENT PROJECT TREND" }),
      /* @__PURE__ */ jsx10(
        TrendLine,
        {
          label: "Session Cost vs Avg",
          value: formatDollars(currentCost),
          trend: costVsAvg >= 1.1 ? `+${((costVsAvg - 1) * 100).toFixed(1)}% above avg` : costVsAvg <= 0.9 ? `-${((1 - costVsAvg) * 100).toFixed(1)}% below avg` : "~at avg",
          barValue: Math.min(1, costVsAvg)
        }
      )
    ] }),
    projects.length === 0 && /* @__PURE__ */ jsx10(Text10, { dimColor: true, children: "No cross-project data yet. Sessions will appear here after they complete." })
  ] });
}, "CrossProject");

// src/tui/full/app.tsx
import { Fragment, jsx as jsx11, jsxs as jsxs11 } from "react/jsx-runtime";
var App = /* @__PURE__ */ __name(({ state, globalDb, onQuit }) => {
  const { exit } = useApp();
  ...
  useInput((input, key) => {
    ...
    if (key.leftArrow) {
      setPage((prev) => prev > 1 ? prev - 1 : 4);
      setShowHelp(false);
      return;
    }
    if (key.rightArrow) {
      setPage((prev) => prev < 4 ? prev + 1 : 1);
      setShowHelp(false);
      return;
    }
  });
  const healthColor = state.health_status === "healthy" ? "green" : state.health_status === "warning" ? "yellow" : "red";
  return /* @__PURE__ */ jsxs11(Box11, { flexDirection: "column", width: "100%", children: [
    /* @__PURE__ */ jsx11(Box11, { flexGrow: 1, children: showHelp ? /* @__PURE__ */ jsx11(HelpOverlay, {}) : /* @__PURE__ */ jsxs11(Fragment, { children: [
      page === 1 && /* @__PURE__ */ jsx11(SessionOverview, { state, globalDb: globalDb ?? null }),
      page === 2 && /* @__PURE__ */ jsx11(ActivityHotspots, { state }),
      page === 3 && /* @__PURE__ */ jsx11(Historical, { state, globalDb: globalDb ?? null }),
      page === 4 && /* @__PURE__ */ jsx11(CrossProject, { state, globalDb: globalDb ?? null })
    ] }) }),
    /* @__PURE__ */ jsxs11(
      Box11,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs11(Box11, { gap: 2, children: [
            /* @__PURE__ */ jsx11(Text11, { color: page === 1 ? "cyan" : "gray", children: "[1] Overview" }),
            /* @__PURE__ */ jsx11(Text11, { color: page === 2 ? "cyan" : "gray", children: "[2] Activity" }),
            /* @__PURE__ */ jsx11(Text11, { color: page === 3 ? "cyan" : "gray", children: "[3] Historical" }),
            /* @__PURE__ */ jsx11(Text11, { color: page === 4 ? "cyan" : "gray", children: "[4] Cross-Project" })
          ] }),
          /* @__PURE__ */ jsxs11(Box11, { gap: 2, children: [
            /* @__PURE__ */ jsx11(Text11, { color: healthColor, children: state.health_status === "healthy" ? "\u25CF healthy" : state.health_status === "warning" ? "\u25CF warning" : "\u25CF alert" }),
            /* @__PURE__ */ jsx11(Text11, { dimColor: true, children: "q: quit  ?: help" })
          ] })
        ]
      }
    )
...
var HelpOverlay = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsxs11(Box11, { flexDirection: "column", padding: 2, gap: 1, children: [
  /* @__PURE__ */ jsx11(Text11, { bold: true, color: "cyan", children: "Analytics Dashboard \u2014 Keyboard Shortcuts" }),
  /* @__PURE__ */ jsxs11(Box11, { flexDirection: "column", gap: 0, marginTop: 1, children: [
    /* @__PURE__ */ jsxs11(Text11, { children: [
      "  ",
      /* @__PURE__ */ jsx11(Text11, { bold: true, children: "1" }),
      "          Navigate to Overview page"
    ] }),
    /* @__PURE__ */ jsxs11(Text11, { children: [
      "  ",
      /* @__PURE__ */ jsx11(Text11, { bold: true, children: "2" }),
      "          Navigate to Activity page"
    ] }),
    /* @__PURE__ */ jsxs11(Text11, { children: [
      "  ",
      /* @__PURE__ */ jsx11(Text11, { bold: true, children: "3" }),
      "          Navigate to Historical page"
    ] }),
    /* @__PURE__ */ jsxs11(Text11, { children: [
      "  ",
      /* @__PURE__ */ jsx11(Text11, { bold: true, children: "4" }),
      "          Navigate to Cross-Project page"
    ] }),
    /* @__PURE__ */ jsxs11(Text11, { children: [
      "  ",
      /* @__PURE__ */ jsx11(Text11, { bold: true, children: "<- / ->" }),
      "   Previous / next page"
    ] }),
    /* @__PURE__ */ jsxs11(Text11, { children: [
      "  ",
    ...
    /* @__PURE__ */ jsxs11(Text11, { children: [
      "  ",
      /* @__PURE__ */ jsx11(Text11, { bold: true, children: "q" }),
      "          Quit dashboard"
    ] })
  ] })
] }), "HelpOverlay");
...
async function main() {
  ...
  const renderApp = /* @__PURE__ */ __name(() => {
    const state = aggregator.getState();
    const globalDb2 = aggregator.getGlobalDb();
    if (inkInstance) {
      inkInstance.rerender(
        React6.createElement(App, { state, globalDb: globalDb2, onQuit: shutdown })
      );
    }
  }, "renderApp");
