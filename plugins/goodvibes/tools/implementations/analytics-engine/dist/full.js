...
import { Box as Box10, Text as Text10, useInput, useApp } from "ink";
...
var SessionOverview = /* @__PURE__ */ __name(({ state }) => {
...
var Historical = /* @__PURE__ */ __name(({ state }) => {
  const { metrics } = state;
  ...
  return /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1, children: [
    ...
    /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", gap: 0, children: [
      ...
      /* @__PURE__ */ jsx9(Text9, { dimColor: true, children: "Historical session archive not yet available in live state. Run with --report flag or view .goodvibes/analytics/sessions/ for archived data." })
    ] }),
    /* @__PURE__ */ jsxs9(Box9, { flexDirection: "column", gap: 0, children: [
...
var App = /* @__PURE__ */ __name(({ state, onQuit }) => {
  const { exit } = useApp();
  ...
  return /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", width: "100%", children: [
    /* @__PURE__ */ jsx10(Box10, { flexGrow: 1, children: showHelp ? /* @__PURE__ */ jsx10(HelpOverlay, {}) : /* @__PURE__ */ jsxs10(Fragment, { children: [
      page === 1 && /* @__PURE__ */ jsx10(SessionOverview, { state }),
      page === 2 && /* @__PURE__ */ jsx10(ActivityHotspots, { state }),
      page === 3 && /* @__PURE__ */ jsx10(Historical, { state })
    ] }) }),
    /* @__PURE__ */ jsxs10(
      Box10,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs10(Box10, { gap: 2, children: [
            /* @__PURE__ */ jsx10(Text10, { color: page === 1 ? "cyan" : "gray", children: "[1] Overview" }),
            /* @__PURE__ */ jsx10(Text10, { color: page === 2 ? "cyan" : "gray", children: "[2] Activity" }),
            /* @__PURE__ */ jsx10(Text10, { color: page === 3 ? "cyan" : "gray", children: "[3] Historical" })
          ] }),
          /* @__PURE__ */ jsxs10(Box10, { gap: 2, children: [
            /* @__PURE__ */ jsx10(Text10, { color: healthColor, children: state.health_status === "healthy" ? "\u25CF healthy" : state.health_status === "warning" ? "\u25CF warning" : "\u25CF alert" }),
            /* @__PURE__ */ jsx10(Text10, { dimColor: true, children: "q: quit  ?: help" })
          ] })
        ]
      }
    )
...
var HelpOverlay = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", padding: 2, gap: 1, children: [
  /* @__PURE__ */ jsx10(Text10, { bold: true, color: "cyan", children: "Analytics Dashboard \u2014 Keyboard Shortcuts" }),
  /* @__PURE__ */ jsxs10(Box10, { flexDirection: "column", gap: 0, marginTop: 1, children: [
    /* @__PURE__ */ jsxs10(Text10, { children: [
      "  ",
      /* @__PURE__ */ jsx10(Text10, { bold: true, children: "1" }),
      "          Navigate to Overview page"
    ] }),
    /* @__PURE__ */ jsxs10(Text10, { children: [
      "  ",
      /* @__PURE__ */ jsx10(Text10, { bold: true, children: "2" }),
      "          Navigate to Activity page"
    ] }),
    /* @__PURE__ */ jsxs10(Text10, { children: [
      "  ",
      /* @__PURE__ */ jsx10(Text10, { bold: true, children: "3" }),
  ...
  const renderApp = /* @__PURE__ */ __name(() => {
    ...
    if (inkInstance) {
      inkInstance.rerender(
        React3.createElement(App, { state, onQuit: shutdown })
      );
    }
  }, "renderApp");
  inkInstance = render(
