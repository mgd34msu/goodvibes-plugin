...
var Historical = /* @__PURE__ */ __name(({ state, globalDb }) => {
  ...
  const comparisonRows = [
    [
      ...
      hasHistory && sessionAvgTokens > 0 ? formatDelta(currentTotalTokens / sessionAvgTokens - 1, 0) : "\u2014"
    ],
    [
      "API Input Tok",
    ...
    [
      ...
      hasHistory && sessionAvgCost > 0 ? formatDelta(cost.total / sessionAvgCost - 1, 0) : "\u2014"
    ],
    [
      "Cost Saved",
