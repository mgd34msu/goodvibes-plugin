...
export const BUILTIN_HOOKS: Record<string, BuiltinHookDefinition> = {
  ...
  typecheck: { phase: 'validate', handler: 'runTypeCheck', description: 'Run TypeScript type checking' },
  lint: { phase: 'validate', handler: 'runLinter', description: 'Run ESLint/Prettier' },
  test: { phase: 'validate', handler: 'runTests', description: 'Run test suite' },
  build: { phase: 'validate', handler: 'runBuild', description: 'Run build process' },
