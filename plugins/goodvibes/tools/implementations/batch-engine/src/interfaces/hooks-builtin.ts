...
export const BUILTIN_HOOKS: Record<string, BuiltinHookDefinition> = {
  ...
  typecheck: { phase: 'validate_after', handler: 'runTypeCheck', description: 'Run TypeScript type checking' },
  lint: { phase: 'validate_after', handler: 'runLinter', description: 'Run ESLint/Prettier' },
  test: { phase: 'validate_after', handler: 'runTests', description: 'Run test suite' },
  build: { phase: 'validate_after', handler: 'runBuild', description: 'Run build process' },
