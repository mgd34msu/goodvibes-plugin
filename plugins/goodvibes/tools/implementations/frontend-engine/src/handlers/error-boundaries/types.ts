 ...
 *
 * @module handlers/frontend/error-boundaries/types
 */
 ...
 *
 * Local definition matching the shape exported by response-utils.ts.
 * Defined here to keep this module self-contained; must stay in sync
 * with the ToolResponse interface in handlers/response-utils.ts.
 */
