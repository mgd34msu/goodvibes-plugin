/**
 * Tailwind Conflicts Analyzer
 *
 * Conflict detection, redundancy detection, specificity issue analysis,
 * and optimization suggestion generation for Tailwind CSS classes.
 *
 * @module core/tailwind-conflicts/analyzer
 */

import type { Conflict, RedundantClass, SpecificityIssue, Suggestion } from './types.js';
import {
  CONTRADICTIONS,
  SHORTHAND_MAP,
  SIZE_SETS_BOTH,
