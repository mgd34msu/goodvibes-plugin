/**
 * Event Flow Analyzers
 *
 * Issue detection, event flow building, delegation pattern detection,
 * and summary generation for event flow analysis.
 *
 * @module handlers/frontend/event-flow-analyzers
 */

import ts from 'typescript';
import type { EventHandler, ComponentNode } from './event-flow-utils.js';
import { BUBBLING_EVENTS, NON_INTERACTIVE_ELEMENTS } from './event-flow-utils.js';
