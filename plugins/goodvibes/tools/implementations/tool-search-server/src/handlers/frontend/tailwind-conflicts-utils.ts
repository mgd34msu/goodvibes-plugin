/**
 * Tailwind Conflicts Utilities
 *
 * Constants and utility functions for Tailwind CSS class categorization,
 * shorthand mappings, and contradiction detection.
 *
 * @module handlers/frontend/tailwind-conflicts-utils
 */
