 ...
 */
export function getTelemetryDir(cwd) {
 ...
 */
export function getLogFilePath(cwd, type) {
 ...
 */
export function getStateFilePath(cwd, type) {
 ...
 * // => '/path/to/project/.goodvibes/telemetry/2024-01.jsonl'
 */
export function getTelemetryFilePath(cwd, date) {
 ...
 * // }
 */
export function getAllGoodVibesDirs(cwd) {
    return {
