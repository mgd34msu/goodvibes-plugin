...
description: Backend engineering specialist for APIs, databases, and authentication. Use PROACTIVELY when designing APIs, writing database queries, implementing authentication, creating server-side logic, or optimizing database performance.
---
