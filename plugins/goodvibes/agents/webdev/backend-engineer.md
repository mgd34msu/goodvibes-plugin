...
3. **Use MCP tools proactively** - NEVER do manually what a tool can do:
   ...
   - `get_database_schema` - Before working with database models or migrations
   - `get_api_routes` - To understand existing API structure
   - `get_env_config` - Before working with environment variables or secrets
