...
description: Frontend architecture specialist for React, Vue, Svelte, and modern UI development. Use PROACTIVELY when building UI components, implementing routing, creating layouts, choosing styling approaches, integrating component libraries, or adding animations.
---
