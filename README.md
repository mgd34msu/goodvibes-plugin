...
[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](https://github.com/mgd34msu/goodvibes-plugin)
...
intelligence**, **session cost analytics**, and an **API workbench** — opt-in
capabilities the native harness doesn't have, and honest about the many things
